...
pre_install_docker_compose(){
    ...
    read -p "(Default leedog@test.com):" cloudflare_email
    [ -z "${cloudflare_email}" ]  && cloudflare_email="leedog@test.com"
    echo
    echo "---------------------------"
    ...
    read -p "(image address (Default leedog/sci-v2:go-free):" docker_addresss
    [ -z "${docker_addresss}" ] && docker_addresss="leedog/sci-v2:go-free"
    echo
    echo "---------------------------"
